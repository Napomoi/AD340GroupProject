...
public class SettingsActivity extends AppCompatActivity implements 	View.OnClickListener {
    ...
    private int AttackingArmiesCount = 3;
    private int AttackingArmiesCountWithToggle;
    private Button btnBackToMain;
    private int DefenderArmiesCount = 1;
    // A bunch of Buttons and a TextView
    private TextView txtStopAtThreeArmiesMode;
    private TextView txtAttackersWinningPercent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtStopAtThreeArmiesMode = (TextView) findViewById(R.id.stopAtThreeArmiesMode);
        txtAttackersWinningPercent = (TextView) findViewById(R.id.attackersWinningPercent);
    ...
    public void onClick(View view2) {
        switch (view2.getId()) {
            ...
            case R.id.btnSubmit:
                    double oddsOfWinning = newodds[AttackingArmiesCount-3][DefenderArmiesCount - 1];
